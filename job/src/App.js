...
const App = () => {
  ...
  const getSearch = e => {
    ...
    let filteredJobs = jobs.filter(
      job => job.location === search || job.companyname === search
    );
  ...
  return (
    <div className="App">
      <header className="App-header">JobBean</header>
      <div className="searchContext">
        <h4>Search your dream jobs here</h4>
      </div>
      ...
      <div className="indexOfJobs">
        <h5>Total Jobs Found : {indexOfAllJobs}</h5>
      </div>
